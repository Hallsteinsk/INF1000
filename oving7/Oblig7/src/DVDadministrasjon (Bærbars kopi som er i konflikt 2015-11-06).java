...
//Metoder	
	...
	public void lesFil(String filnavn) throws FileNotFoundException{
		...
		String linje = null, person = null, laaner = null; 
		...
		while(innFil.hasNextLine()){
			if(linje.equals("-")){
				...
				if(linje.charAt(0) == '*'){
					laaner = innFil.nextLine();
					kjop(linje.substring(1), person);
					laan(linje.substring(1), person, laaner);
					System.out.println("laan " + linje.substring(1) + " " + person + " " + laaner);
				}
				else{
					kjop(linje, person);
